...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    List.fold_left (fun a -> a.action arg) () !evt
...
let a_id = add_listener newswire fakeNewsNetwork;
let b_id = add_listener newswire buzzFake;;
...
remove_listener newswire a_id;
remove_listener newswire b_id;;
...
let receive_report (s : string) : unit =
                                        add_listener  fun () -> (fakeNewsNetwork s);
                                        fun () -> (buzzFake s);
